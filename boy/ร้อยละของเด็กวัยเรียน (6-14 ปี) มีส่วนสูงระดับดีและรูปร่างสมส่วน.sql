...
SELECT distcode,t01.HOSPCODE,t01.PID,cid,name,lname,birth,t01.m,if(t01.h_rs in('3','4','5') AND t01.wh_rs=3,"สมส่วน","ไม่สมส่วน") a
FROM (
...
)t01 left join chospital on t01.hospcode = chospital.hoscode
